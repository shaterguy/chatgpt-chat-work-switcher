(() => {
  ...
  function post(type, payload = {}) {
    window.postMessage({ channel: CHANNEL, direction: 'extension-to-bridge', type, ...payload }, '*');
  }
  ...
  chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    if (!message || message.source !== 'chatgpt-request-snapshot-popup') return undefined;
    (async () => {
