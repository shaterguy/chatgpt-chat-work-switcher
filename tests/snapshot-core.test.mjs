...
import '../src/snapshot-core.js';

const core = globalThis.ChatGptRequestSnapshotCore;

test('captures control primitives but excludes messages, identifiers and auth-like values', () => {
  const body = {
    action: 'next',
...
test('minimal plan includes first-turn axes and Work same-conversation turn switching', () => {
